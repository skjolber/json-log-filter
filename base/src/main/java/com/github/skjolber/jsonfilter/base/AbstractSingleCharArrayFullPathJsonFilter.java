...
public abstract class AbstractSingleCharArrayFullPathJsonFilter extends AbstractSinglePathJsonFilter {
	...
	public AbstractSingleCharArrayFullPathJsonFilter(int maxStringLength, int maxSize, int maxPathMatches, String expression, FilterType type, String pruneMessage, String anonymizeMessage, String truncateMessage) {

...
public class FullPathJsonFilter extends AbstractRangesPathJsonFilter {

	public FullPathJsonFilter(int maxPathMatches, String[] anonymizes, String[] prunes, String pruneMessage, String anonymizeMessage, String truncateMessage) {
	...
	public FullPathJsonFilter(int maxPathMatches, String[] anonymizes, String[] prunes) {

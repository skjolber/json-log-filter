...
public class PathJsonFilter extends AbstractRangesPathJsonFilter {

	public PathJsonFilter(int maxPathMatches, String[] anonymizes, String[] prunes, String pruneMessage, String anonymizeMessage, String truncateMessage) {
		super(-1, -1, maxPathMatches, anonymizes, prunes, pruneMessage, anonymizeMessage, truncateMessage);
	}
	
	public PathJsonFilter(int maxPathMatches, String[] anonymizes, String[] prunes) {

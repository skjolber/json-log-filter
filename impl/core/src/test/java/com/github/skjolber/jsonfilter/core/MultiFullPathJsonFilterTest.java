...
public class MultiFullPathJsonFilterTest extends DefaultJsonFilterTest {
	...
	public void exception_returns_false() throws Exception {
		assertFalse(new MultiFullPathJsonFilter(-1, null, null).process(new char[] {}, 1, 1, new StringBuilder()));
	}

	@Test
	public void exception_offset_if_not_exceeded() throws Exception {
		assertNull(new MultiFullPathJsonFilter(-1, null, null).process(TRUNCATED));
		assertFalse(new MultiFullPathJsonFilter(-1, null, null).process(FULL, 0, FULL.length - 3, new StringBuilder()));
	}

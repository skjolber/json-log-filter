...
public class PreprocessedJsonHttpRequest extends AbstractFilterHttpMessage<HttpRequest> implements HttpRequest {

	public PreprocessedJsonHttpRequest(HttpRequest request, JsonProcessor jsonProcessor) {

...
public class JacksonAnyPathMaxStringLengthJsonFilterTest extends AbstractDefaultJacksonJsonFilterTest {
	...
	public JacksonAnyPathMaxStringLengthJsonFilterTest() throws Exception {
		super(true);
	}
	...
	public void passthrough_success() throws Exception {
		...
		assertThat(new JacksonAnyPathMaxStringLengthJsonFilter(-1, new String[]{ANY_PASSTHROUGH_XPATH}, new String[]{ANY_PASSTHROUGH_XPATH})).hasPassthrough();
	}
	
	@Test
	public void anonymizeAny() throws Exception {
		assertThat(new JacksonAnyPathMaxStringLengthJsonFilter(-1, new String[]{DEFAULT_ANY_PATH}, null)).hasAnonymized(DEFAULT_ANY_PATH);
	}

	@Test
	public void pruneAny() throws Exception {
		assertThat(new JacksonAnyPathMaxStringLengthJsonFilter(-1, null, new String[]{DEFAULT_ANY_PATH})).hasPruned(DEFAULT_ANY_PATH);
	}	

	@Test
	public void maxStringLength() throws Exception {
		assertThat(new JacksonAnyPathMaxStringLengthJsonFilter(DEFAULT_MAX_STRING_LENGTH, null, null)).hasMaxStringLength(DEFAULT_MAX_STRING_LENGTH);
	}
	
	@Test
	public void maxStringLengthAnonymizePrune() throws Exception {
		assertThat(new JacksonAnyPathMaxStringLengthJsonFilter(DEFAULT_MAX_STRING_LENGTH, new String[]{"//key1"}, new String[]{"//key3"}))
	...
	public void testConvenienceMethods() throws IOException {
		...
		testConvenienceMethods(
			new JacksonAnyPathMaxStringLengthJsonFilter(-1, null, null) {

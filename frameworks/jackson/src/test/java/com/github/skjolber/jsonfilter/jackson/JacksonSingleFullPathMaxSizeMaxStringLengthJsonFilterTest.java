...
public class JacksonSingleFullPathMaxSizeMaxStringLengthJsonFilterTest extends AbstractJacksonJsonFilterTest {
	...
	public void anonymize() throws Exception {
		MaxSizeJsonFilterFunction maxSize = (size) -> new JacksonSingleFullPathMaxSizeMaxStringLengthJsonFilter(size, -1, DEFAULT_PATH, FilterType.ANON);
	...
	public void anonymizeWildcard() throws Exception {
		MaxSizeJsonFilterFunction maxSize = (size) -> new JacksonSingleFullPathMaxSizeMaxStringLengthJsonFilter(size, -1, DEFAULT_WILDCARD_PATH, FilterType.ANON);
	...
	public void prune() throws Exception {
		MaxSizeJsonFilterFunction maxSize = (size) -> new JacksonSingleFullPathMaxSizeMaxStringLengthJsonFilter(size, -1, DEFAULT_PATH, FilterType.PRUNE);
	...
	public void pruneWildcard() throws Exception {
		MaxSizeJsonFilterFunction maxSize = (size) -> new JacksonSingleFullPathMaxSizeMaxStringLengthJsonFilter(size, -1, DEFAULT_WILDCARD_PATH, FilterType.PRUNE);
	...
	public void maxStringLength() throws Exception {
		MaxSizeJsonFilterFunction maxSize = (size) -> new JacksonSingleFullPathMaxSizeMaxStringLengthJsonFilter(DEFAULT_MAX_STRING_LENGTH, size, PASSTHROUGH_XPATH, FilterType.PRUNE);
